const WorkExpList = ({designation, companyName, summary, joiningDate, lastWorkingDate, currentlyWorking}) => {
    return(
        <li data-aos="fade-up" className="flex flex-col relative pl-4 lg:pl-20 before:content-[''] before:absolute before:left-[-4px] before:w-2 before:h-2 before:rounded-full before:top-0 before:bg-black dark:before:bg-slate-700 mb-14">
