            ...
            <div className="container mx-auto">
                <div className="flex flex-col lg:flex-row justify-between items-start">
                    <div className='flex flex-col lg:mt-10 lg:pt-5  items-center justify-center  w-full p-0 bg-stone-200 dark:bg-slate-700 lg:bg-transparent dark:lg:bg-transparent'>
                        <img src={isDarkMode ? UserImg : UserImgDark} alt="Arman Ali" className="max-w-80 lg:max-w-full lg:rounded-full" />
                    </div>
                    <div className="flex px-4 lg:px-0 flex-col w-full lg:w-8/12 mt-10 rounded-md lg:p-5 pt-0 lg:pl-14">
                        ...
                        <ul className="flex flex-col mt-3 ">
                            <li className="mb-8">
                                ...
                                <h2 className="text-slate-700 dark:text-slate-300 font-bold text-xl mt-0">Frontend Developer</h2>
                            </li>
                            <li className="mb-8">
                                ...
                                <h3 className="text-slate-700 dark:text-slate-300 font-bold text-xl mt-0">5 Years</h3>
                            </li>
                            <li className="mb-8">
